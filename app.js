...
function orderfood(){
    ...
    console.log(`Dear ${name}, your ordered food ${food} will be ready in 15 minutes and will be delivered to your address ${address}`);
}
...
function totalprice(){
    ...
    for (let i = 1; i <= 10; i++) {
        ...
        if (i === 3) {
            total *= 0.9;
            console.log("Discount applied after 3 items!");
        }
        if (i >= 5) {
            total *= 0.8;  
            console.log("Additional discount applied after 5 items!");
        }
    }
